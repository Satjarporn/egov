            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center inner">
                  <h1 class="animated fadeInDown">Hello, again<br><span>Mentor</span></h1>
              ...
              <div class="col-md-12">
                <div class="features-wrapper">
                  <div class="col-md-6 wp2">
                    ...
                    <h2>Choose task to comment</h2>')?>
                    <p>give comment to the developer for more understanding</p>
                  </div>
                  <div class="col-md-6 wp2 delay-05s">
                    <?php echo anchor('send','<div class="icon">
                      <i class=" fa fa-cloud-upload shadow"></i>
                    </div>
                    <h2>commented task</h2>')?>
