          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-8 col-md-offset-2">
                <h1>Workspace<span>Your Working Area<br>choose tasks and have fun!</span></h1>
...
<div class="col-md-8"> 
            ...
            <div class="panel panel-default">
              ...
              <div id="task1" class="panel-collapse collapse">
                <div class="panel-body">
                 ...
                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#sendTask">Send your work</button>
          ...
          <div class="panel panel-success">
           ...
           <!-- update task -->
            <div id="sendTask" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
           ...
           <div class="modal-content">
            ...
            <form role="form" class="taskModal">
              ...
              <div class="form-group">
                 <input type="file" style="display: inline-flex;" id="taskFile">
